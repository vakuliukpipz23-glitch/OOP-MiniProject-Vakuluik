...
## Розширення Ітерації 2

У Lab 35 до діаграми додано збереження стану та аналітичні запити:
- `Program.cs` зчитує `data/library.json` на старті
- `LibraryPersistenceService` відновлює стан книг, копій, відвідувачів і позичок
- `LibraryQueryService` виконує LINQ-запити для пошуку і статистики
